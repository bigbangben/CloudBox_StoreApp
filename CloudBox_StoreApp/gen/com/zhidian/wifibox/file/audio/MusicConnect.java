 ...
 * Original file: E:\\workspace\\CloudBox_StoreApp\\src\\com\\zhidian\\wifibox\\file\\audio\\MusicConnect.aidl
 */
package com.zhidian.wifibox.file.audio;
public interface MusicConnect extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.zhidian.wifibox.file.audio.MusicConnect
{
private static final java.lang.String DESCRIPTOR = "com.zhidian.wifibox.file.audio.MusicConnect";
...
/**
 * Cast an IBinder object into an com.zhidian.wifibox.file.audio.MusicConnect interface,
 * generating a proxy if needed.
 */
public static com.zhidian.wifibox.file.audio.MusicConnect asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.zhidian.wifibox.file.audio.MusicConnect))) {
return ((com.zhidian.wifibox.file.audio.MusicConnect)iin);
}
return new com.zhidian.wifibox.file.audio.MusicConnect.Stub.Proxy(obj);
}
...
java.util.List<com.zhidian.wifibox.file.audio.MusicData> _arg0;
_arg0 = data.createTypedArrayList(com.zhidian.wifibox.file.audio.MusicData.CREATOR);
...
data.enforceInterface(DESCRIPTOR);
java.util.List<com.zhidian.wifibox.file.audio.MusicData> _arg0;
_arg0 = new java.util.ArrayList<com.zhidian.wifibox.file.audio.MusicData>();
...
case TRANSACTION_isPlay:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isPlay();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
private static class Proxy implements com.zhidian.wifibox.file.audio.MusicConnect
{
...
@Override public void refreshMusicList(java.util.List<com.zhidian.wifibox.file.audio.MusicData> musicFileList) throws android.os.RemoteException
{
...
@Override public void getFileList(java.util.List<com.zhidian.wifibox.file.audio.MusicData> musicFileList) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_reply.readException();
_reply.readTypedList(musicFileList, com.zhidian.wifibox.file.audio.MusicData.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public boolean isPlay() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isPlay, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_isPlay = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_seekTo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_getCurPosition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
...
public void refreshMusicList(java.util.List<com.zhidian.wifibox.file.audio.MusicData> musicFileList) throws android.os.RemoteException;
public void getFileList(java.util.List<com.zhidian.wifibox.file.audio.MusicData> musicFileList) throws android.os.RemoteException;
...
public boolean isPlay() throws android.os.RemoteException;
